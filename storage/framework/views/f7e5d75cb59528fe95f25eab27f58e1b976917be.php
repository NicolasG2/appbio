...
<head>
    ...
    <title>BioProject - Toipes & Amigos</title>
...
<body>
    <nav class="navbar sticky-top navbar-expand-md">
        <div class="container-fluid">
            <a href="<?php echo e(route('index')); ?>" class="navbar-brand">
                <img src="<?php echo e(asset('img/Miles-logo.png')); ?>" width="64" height="64">
                <span class="ms-3 fs-5 fw-bold">BioProject - Toipes & Amigos</span>
            </a>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown ps-2">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#cfebfd" class="bi bi-gear-fill" viewBox="0 0 16 16">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<?php echo e(route('atividade.index')); ?>" class="dropdown-item">
                            ...
                            <li>
                                <a href="<?php echo e(route('integrante.index')); ?>" class="dropdown-item">
                            ...
                            <li>
                                <a href="<?php echo e(route('material.index')); ?>" class="dropdown-item">
    ...
    <div class="container py-4">
        <div class="row">
            <div class="col-2">
                <?php if($menu == "admin"): ?>
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#1685d3" class="bi bi-gear-fill" viewBox="0 0 16 16">
                        <path d="M9.405 1.05c-.413-1.4-2.397-1.4-2.81 0l-.1.34a1.464 1.464 0 0 1-2.105.872l-.31-.17c-1.283-.698-2.686.705-1.987 1.987l.169.311c.446.82.023 1.841-.872 2.105l-.34.1c-1.4.413-1.4 2.397 0 2.81l.34.1a1.464 1.464 0 0 1 .872 2.105l-.17.31c-.698 1.283.705 2.686 1.987 1.987l.311-.169a1.464 1.464 0 0 1 2.105.872l.1.34c.413 1.4 2.397 1.4 2.81 0l.1-.34a1.464 1.464 0 0 1 2.105-.872l.31.17c1.283.698 2.686-.705 1.987-1.987l-.169-.311a1.464 1.464 0 0 1 .872-2.105l.34-.1c1.4-.413 1.4-2.397 0-2.81l-.34-.1a1.464 1.464 0 0 1-.872-2.105l.17-.31c.698-1.283-.705-2.686-1.987-1.987l-.311.169a1.464 1.464 0 0 1-2.105-.872l-.1-.34zM8 10.93a2.929 2.929 0 1 1 0-5.86 2.929 2.929 0 0 1 0 5.858z"/>
                    </svg>
                <?php elseif($menu == "home"): ?>
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#1685d3" class="bi bi-house-door-fill" viewBox="0 0 16 16">
                        <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5Z"/>
                    </svg>
                <?php else: ?>
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#1685d3" class="bi bi-card-list" viewBox="0 0 16 16">
            ...
            <div class="col-8 d-flex justify-content-center">
                <span class="principal fs-4 fw-bold"><?php echo e(mb_strtoupper($submenu, 'UTF-8')); ?></span>
            </div>
            <div class="col-2 d-flex justify-content-end">
                <?php if(isset($rota)): ?>
                    <a href= "<?php echo e(route($rota)); ?>" class="btn btn-success ms-2">    
...
<nav class="navbar fixed-bottom navbar-dark">
    <div class="container-fluid">
        <span class="text-white fw-light fw-bold"><b>Projeto Multidisciplinar:</b> Biologia II + Desenvolvimento Web</span>
    </div>
</nav>
...
</html><?php /**PATH /var/www/html/appbio-andrenicolas/resources/views/template/main.blade.php ENDPATH**/ ?>