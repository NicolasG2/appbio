                        ...
                        <div class="accordion-body">
                            <div class="row">
                                <div class="col-md-2 col-xs-12">
                                    <img src="<?php echo e(asset("storage/$item->foto")); ?>" width="128" height="128" style="border-radius: 50%;"> 
                                </div>
                                <div class="col-md-10 col-xs-12 d-flex align-items-center justify-content-center">
                                    <p class="text-success fs-6"><?php echo e($item->descricao); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('template.main', ['menu' => "home", "submenu" => "Atividades"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/appbio-andrenicolas/resources/views/site/atividade.blade.php ENDPATH**/ ?>