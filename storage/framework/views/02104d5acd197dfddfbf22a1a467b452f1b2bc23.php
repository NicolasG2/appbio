...
<form action="<?php echo e(route('atividade.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>  
    <div class="row">
        <div class="col" >
    ...
    <div class="row">
        <div class="col">
            <div class="form-floating mb-3">
                <input
                    type="date"
                    class="form-control <?php if($errors->has('data')): ?> is-invalid <?php endif; ?>"
                    name="data"
                    min="2023-08-21"
                    max="2023-10-10"
                    style="min-height: 100px"
                ><?php echo e(old('data')); ?></input>
...
<?php echo $__env->make('template.main', ['menu' => "admin", 'submenu' => "Nova Atividade"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/appbio-andrenicolas/resources/views/atividade/create.blade.php ENDPATH**/ ?>