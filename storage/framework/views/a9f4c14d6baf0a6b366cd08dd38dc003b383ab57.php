    ...
    <nav class="navbar sticky-top navbar-expand-md navbar-dark bg-success">
        <div class="container-fluid">
            <a href="<?php echo e(route('index')); ?>" class="navbar-brand">
                <img src="<?php echo e(asset('img/natureza.png')); ?>" width="64" height="64">
    ...
    <div class="container py-4">
        <div class="row">
            ...
            <div class="col-8 d-flex justify-content-center">
                <span class="text-success fs-4 fw-bold"><?php echo e(mb_strtoupper($submenu, 'UTF-8')); ?></span>
            </div>
...
</html><?php /**PATH /var/www/html/appbio-andrenicolas/resources/views/templates/main.blade.php ENDPATH**/ ?>